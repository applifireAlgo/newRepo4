Ext.define('Testlic.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Testlic.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Testlic.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Testlic.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Testlic.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Testlic.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Testlic.view.clouddrive.CloudDrive");
    },
    ...
    loadLangCombo : function(){
     ...
     onSearchClick : function(searchBtn){
        ...
        var searchView = this.pushViewInMainTab("Testlic.view.searchengine.search.SearchEngineMainPanel","Search Result","isSearchCmp","true");
