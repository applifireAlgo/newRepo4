 ...
 */
Ext.define('Testlic.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testlic.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testlic.view.fw.component.DateTimePicker(o);
    },
