Ext.define('Testlic.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Testlic.view.usermanagement.enduser.UserProfileController', 'Testlic.view.usermanagement.admin.AddUserDetailsViewModel', 'Testlic.model.AddUserDataModel' ],
