Ext.define('Testlic.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testlic.view.usermanagement.admin.AddUserDetailsViewModel', 'Testlic.model.AddUserDataModel' ],
