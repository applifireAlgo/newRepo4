Ext.define('Testlic.testlic.web.com.controller.appinsight.health.TestOneMainController', {
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#TestOneGrid');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#TestOneForm').down('#' + me.column.dataIndex + '').store;
