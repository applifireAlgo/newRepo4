...
@Table(name = "ast_TestOne_M")
@Entity
@Cache(type = CacheType.CACHE)
@SourceCodeAuthorClass(createdBy = "shweta.zagade1209@gmail.com", updatedBy = "shweta.zagade1209@gmail.com", versionNumber = "3", comments = "TestOne", complexity = Complexity.LOW)
...
public class TestOne implements Serializable, CommonEntityInterface, Comparator<TestOne> {
    ...
    public void setaOne(Integer _aOne) {
        if (_aOne != null) {
            this.aOne = _aOne;
        }
    }
    ...
    public void setaTwo(Integer _aTwo) {
        if (_aTwo != null) {
            this.aTwo = _aTwo;
        }
    }
