...
public class EmpTestCase extends EntityTestCriteria {
    ...
    private Emp createEmp(Boolean isSave) throws Exception {
        Emp emp = new Emp();
        emp.setEmpName("UkThUf3AEUHXC9hNLol9p8VQOOsYqECs7FjKgX9GP08q21uBor");
    ...
    public void test2Update() {
        try {
            ...
            emp.setEmpName("dmyWXXj7BNVWWeYdlkDXbxJBNN9kYJDyCNvTZBRZeoFCLEM33r");
            emp.setEmpNo(2147483647);
            emp.setVersionId(1);
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "empName", ""));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 3, "empNo", null));
