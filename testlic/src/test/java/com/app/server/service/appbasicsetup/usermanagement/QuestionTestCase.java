...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("J2nZeEudFU");
        question.setQuestion("Zk9uDI5E8GH9gbD3lVfsxlnsEFUAnY5WMRmfW89XRoFCeHx5M5");
        question.setLevelid(8);
        question.setQuestionIcon("K8ezta2A57JsygyqAiRSzuvrMFb9HzGyykUKQiUAkv28399R3T");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("aZCrSyXrFB");
            question.setQuestion("2OPMQfkSO7eUk6Dbu7lw0OWiIGkZSUrFAYCg54LqFgn6EQhI80");
            question.setLevelid(7);
            question.setQuestionIcon("PVRcoYuEKRMROy9mtjGhoRzNPNTFgTD9qci1HD7U2wTm5pnLuJ");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "KhlZDRbMEH2HjeGSDTXWnsrFg6yQ5LMnhdv29FpFpna1JqI1x7K9ZFeF4sQhopQ3P"));
