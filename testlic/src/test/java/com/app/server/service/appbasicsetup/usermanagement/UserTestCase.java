...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainDescription("cBrDZMg0VVlte3UKNGRtKGeYTjP2KKWgcdmUncl32BgjgW7e59");
        useraccessdomain.setDomainName("u0W38arsyyziN4V1koEgUti9hGW7kHnzsI5o7rtbTNc2eTbZ5l");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainHelp("2bxW8UD19DRZ5frMJSvloyvEZb0rvMTYEsGx4PmLbCBRfYtkOS");
        useraccessdomain.setDomainIcon("9eVG3tR7JRvMbIKwz2bIbWeIw7VZcgKspOakoVYM1n5tNUNyPI");
        ...
        useraccesslevel.setLevelIcon("IiedlHhmW2T2m0mDrgnQAbQzts1P5MTf7FGoaXAlV9MdWherD1");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelName("LxM9lb9dwUsWskBV9SXfaGwWIZYxVerpVwMoU2DKbL7lo7fn0L");
        useraccesslevel.setLevelHelp("HZie8QblDqczAZtNu6wm6WIE3Xgm3magGtVhKciQNkOoCXW83Z");
        useraccesslevel.setLevelDescription("NFGOt9WXC8o1E4UZOsn4PLC16vzeFmIlWW86Pr27zmjdylz5Cv");
        ...
        user.setPasswordAlgo("wZ5Ugr8mWW51zMBNOwAPCRs15yVwNzkdEBLspyVCe7yua0xFEY");
        user.setIsDeleted(1);
        user.setUserAccessCode(16314);
        user.setChangePasswordNextLogin(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1465475240105l));
        user.setPasswordExpiryDate(new java.sql.Timestamp(1465475240105l));
        user.setGenTempOneTimePassword(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setAllowMultipleLogin(1);
        user.setSessionTimeout(3086);
        user.setIsLocked(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("sE6fX6tBOkaZ1sWXlvKVvcwHEVnpmXfeFBxR9x99exkmmJblft");
        Question question = new Question();
        question.setQuestionDetails("IggMSuBgmO");
        question.setQuestion("pj8cvE84ofpOe62qfJtzUwND2TdCHUEHjCvhDnGBLtwGQPluEx");
        question.setLevelid(9);
        question.setQuestionIcon("ViCijSfK2BVAqcKKWlVEqKQcbmABgcftWULHU3e75JEIQa2ops");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("cPWst9PHldnTshTe6wf757Q6TXNhsDZtCiKo1awiYG6LseUsnd");
        ...
        userdata.setOneTimePassword("Zh2VBoUptzJnZ9lU7VGsRljYDu0FErjQ");
        userdata.setLast5Passwords("ENFwzL3AswwziJ7eTHIhbNpBEZM6aJq0G0THIjDuUcr3ndREE1");
        userdata.setPassword("GALRInjVM3zuUGYKcIeq8COPEW7z1JAW3Ffs0B53JuvBnsTgjN");
        userdata.setOneTimePasswordExpiry(6);
        userdata.setOneTimePassword("gNs5wagS2PMH8vryccm3AXzRAdDjZPUW");
        userdata.setLast5Passwords("Bpcm9oMZxOVq06oX7NYosXsuyKCvMDPy917a1TsZvnq0t5L3bj");
        userdata.setPassword("bEBIxve5etUmPUywVi0Dmi7EGr7eW5bSm6XqjGcgKq3tyMhjTj");
        userdata.setUser(user);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1465475241255l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 68575));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "8cUcobyI7StT0GxoI0jfn0vv80ur8DkUIzMPEcQ7a7KO5YQjVBTQY0QanPMTN8n80"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 6433));
