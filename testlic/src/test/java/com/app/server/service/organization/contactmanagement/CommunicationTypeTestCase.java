...
public class CommunicationTypeTestCase extends EntityTestCriteria {
    ...
    private CommunicationType createCommunicationType(Boolean isSave) throws Exception {
        ...
        communicationgroup.setCommGroupName("0C8txTIMNvt2fRhmKAHpf2vMISIML0RoGmd88LAhNOmpZ78HN3");
        communicationgroup.setCommGroupDescription("0JSwZQ6uACHm8yBvhkBhQGbGUx94OtJMsDnkQBZ4Wn429SG60W");
        ...
        communicationtype.setCommTypeName("Z4zMFD5AewpnChpIVdNYqwoPLnWTn59UAmVxIuHKqQ6CjxK8TT");
        communicationtype.setCommTypeDescription("7ylzyw9ltozr08xBOPYfLj30SXqgMFs6izOZ1S5wPCfHT2x6I6");
    ...
    public void test2Update() {
        try {
            ...
            communicationtype.setCommTypeName("5trZLX1gbcyL9lLaJ7MCoQ1C7yBUNK6iJKk6LF64AsEWFDT7iq");
            communicationtype.setCommTypeDescription("cMArcvRHKgyVGaKqAi0Fmgh1PUMzsiAj9TidMMIVsoVvoex652");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commTypeName", "0mUDh3op7H3A71ZL59KOlkXmJbTMKvwa7OUpF8f1v71hBHUia3TUucOnMYgHXNSn8wlCDIm4Hywx8t5Ray5IOA3b38caKICK1yoB6kGBspDnY5rMIJDPjhabRe4SpHdnF"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commTypeDescription", ""));
