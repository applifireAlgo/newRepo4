...
public class TestOneTestCase extends EntityTestCriteria {
    ...
    private TestOne createTestOne(Boolean isSave) throws Exception {
        ...
        testone.setaTwo(2147483647);
        testone.setaOne(2147483647);
        testone.setTotal(2147483647);
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 1, "aOne", null));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 2, "aTwo", null));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 3, "total", null));
