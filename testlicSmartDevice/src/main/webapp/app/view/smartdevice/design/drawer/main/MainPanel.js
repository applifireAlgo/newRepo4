Ext.define('Testlic.view.smartdevice.design.drawer.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Testlic.view.googlemaps.map.MapPanel','Testlic.view.smartdevice.searchengine.SearchEngineMainView','Testlic.view.smartdevice.design.drawer.main.MainPanelController','Testlic.view.smartdevice.design.resource.AppFormsList'],
    userinfo:{},
    id:'mainPanel',
