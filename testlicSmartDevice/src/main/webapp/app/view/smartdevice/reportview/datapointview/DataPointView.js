Ext.define('Testlic.view.smartdevice.reportview.datapointview.DataPointView', {
	extend : 'Ext.panel.Panel',
	requires:['Testlic.view.smartdevice.reportview.datapointview.DataPointViewController'],
