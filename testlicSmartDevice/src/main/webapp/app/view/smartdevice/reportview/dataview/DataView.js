Ext.define('Testlic.view.smartdevice.reportview.dataview.DataView', {
	extend : 'Ext.panel.Panel',
	requires:['Testlic.view.smartdevice.reportview.dataview.DataViewController','Testlic.view.smartdevice.reportview.dataview.DataDetailViewModel'],
