Ext.define('Testlic.view.smartdevice.reportview.querycriteria.QueryCriteria', {
	extend : 'Ext.panel.Panel',
	requires:['Testlic.view.smartdevice.reportview.querycriteria.QueryCriteriaController'],
