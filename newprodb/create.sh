...
sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_Brands_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_Category_M.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_Item_T.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_Tone_T.sql; 

sqlplus $USER/$PASSWORD @$AST_CREATE_PATH/ast_Ttwo_T.sql; 
