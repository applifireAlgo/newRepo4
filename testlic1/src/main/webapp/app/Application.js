 ...
 */
Ext.define('Testlic1.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Testlic1.view.databrowsercalendar.DBCalendar"],
	...
	stores : [ 'Testlic1.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Testlic1.view.login.SessionLogin').center();
