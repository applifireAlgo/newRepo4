Ext.define('Testlic1.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testlic1.view.usermanagement.admin.AddUserDetailsViewModel', 'Testlic1.model.AddUserDataModel' ],
