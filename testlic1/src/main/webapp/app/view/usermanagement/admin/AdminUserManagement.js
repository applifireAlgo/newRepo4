Ext.define('Testlic1.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testlic1.view.usermanagement.admin.UserPasswordReset',
	            'Testlic1.view.usermanagement.admin.AddUserDetails',
	            'Testlic1.view.usermanagement.admin.ViewUser'],
