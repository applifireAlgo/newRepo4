 ...
 * 
 */
Ext.define('Testlic1.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testlic1.view.securityconfig.SecurityConfigController',
			'Testlic1.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
