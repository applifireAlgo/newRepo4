 ...
 * 
 */
Ext.define('Testlic1.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testlic1.view.logalarm.mainscreen.AddLogAlarmController',
			'Testlic1.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testlic1.view.logalarm.mainscreen.AppAlarmPanel',
