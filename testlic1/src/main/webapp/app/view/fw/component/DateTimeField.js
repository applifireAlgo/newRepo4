 ...
 */
Ext.define('Testlic1.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testlic1.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testlic1.view.fw.component.DateTimePicker(o);
    },
