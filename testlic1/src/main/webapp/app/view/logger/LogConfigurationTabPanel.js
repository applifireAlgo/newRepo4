...
Ext
		.define(
				'Testlic1.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testlic1.view.logger.tabs.details.DetailsTab',
							'Testlic1.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testlic1.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testlic1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testlic1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testlic1.view.logger.LogConfigurationTabPanelController',
