 ...
 * 
 */
Ext.define('Testlic1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testlic1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
