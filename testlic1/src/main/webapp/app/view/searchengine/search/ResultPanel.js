Ext
		.define(
				'Testlic1.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testlic1.view.searchengine.search.SearchEngineMainPanelController','Testlic1.view.searchengine.search.PanelHeaderField' ,'Testlic1.view.searchengine.search.ReportGridView','Testlic1.view.searchengine.search.ReportChartView','Testlic1.view.searchengine.search.documentView','Testlic1.view.searchengine.search.DouMeanView','Testlic1.view.googlemaps.map.MapPanel'],
