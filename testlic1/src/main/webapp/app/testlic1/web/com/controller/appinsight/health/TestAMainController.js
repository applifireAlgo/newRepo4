Ext.define('Testlic1.testlic1.web.com.controller.appinsight.health.TestAMainController', {
     extend: 'Testlic1.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.TestAMainController',
     init: function() {
          var form = this.view.down('#TestAForm');
     ...
     renderTreeGridData: function(responseData) {
          ...
          if (responseData.response.success) {
               ...
               var tree = this.view.down('#TestATree');
               ...
               var compRef = this.view.down('#TestATree');
     ...
     resetForm: function(but) {
          ...
          form.down('#saveFormButton').setText('Save');
          form.reset();
          var grid = this.view.down('#TestAGrid');
          var tree = this.view.down('#TestATree');
          tree.setSelection();
          grid.setSelection();
     },
     hideDataBrowser: function() {
          var form = this.view.down('#TestA');
          var grid = this.view.down('#TestAGrid');
          var tree = this.view.down('#TestATreeContainer');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#TestAForm');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, opts) {
                    ...
                    var compRef = currentView.down('#TestATree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          ...
          if (record.data.leaf) {
               var TestA = this.view.down('#TestAForm');
               TestA.reset();
               var gridPanel = this.view.down('#TestAGrid');
          ...
          var formPanel = this.getView().up().down('#TestAForm');
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#TestATree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#TestA').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#TestAGrid').store;
          gridStore.removeAll();
          gridStore.add(data);
