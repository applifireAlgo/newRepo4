...
@RestController
@SourceCodeAuthorClass(createdBy = "shweta.zagade1209@gmail.com", updatedBy = "", versionNumber = "1", comments = "Service for AddressType Master table Entity", complexity = Complexity.LOW)
...
public class AddressTypeServiceImpl extends AddressTypeService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        ...
        AppAlarm appAlarm = Log.getAlarm("ORGLM224990200");
    ...
    public HttpEntity<ResponseBean> save(@RequestBody AddressType entity) throws Exception {
        ...
        AppAlarm appAlarm = Log.getAlarm("ORGLM222990200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "AddressType"));
    ...
    public HttpEntity<ResponseBean> delete(@PathVariable("cid") String entity) throws Exception {
        ...
        AppAlarm appAlarm = Log.getAlarm("ORGLM228990200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "AddressType"));
    ...
    public HttpEntity<ResponseBean> update(@RequestBody AddressType entity) throws Exception {
        ...
        AppAlarm appAlarm = Log.getAlarm("OGMLM221990200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "AddressType"));
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        responseBean.add("message", String.format(appAlarm.getMessage(), "AddressType"));
        responseBean.add("data", lstaddresstype);
        Log.out.println("ORGLM224990200", runtimeLogInfoHelper.getRequestHeaderBean(), "AddressTypeServiceImpl", "save", "AddressType");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
