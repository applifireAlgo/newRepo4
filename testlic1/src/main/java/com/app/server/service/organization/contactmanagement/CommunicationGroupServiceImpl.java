...
@RestController
@SourceCodeAuthorClass(createdBy = "shweta.zagade1209@gmail.com", updatedBy = "", versionNumber = "1", comments = "Service for CommunicationGroup Master table Entity", complexity = Complexity.LOW)
...
public class CommunicationGroupServiceImpl extends CommunicationGroupService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        ...
        AppAlarm appAlarm = Log.getAlarm("ORGCM224990200");
    ...
    public HttpEntity<ResponseBean> save(@RequestBody CommunicationGroup entity) throws Exception {
        ...
        AppAlarm appAlarm = Log.getAlarm("ORGCM2229901200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "CommunicationGroup"));
    ...
    public HttpEntity<ResponseBean> delete(@PathVariable("cid") String entity) throws Exception {
        ...
        AppAlarm appAlarm = Log.getAlarm("ORGCM228990200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "CommunicationGroup"));
    ...
    public HttpEntity<ResponseBean> update(@RequestBody CommunicationGroup entity) throws Exception {
        ...
        AppAlarm appAlarm = Log.getAlarm("ORGCM221990200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "CommunicationGroup"));
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        responseBean.add("message", String.format(appAlarm.getMessage(), "CommunicationGroup"));
        responseBean.add("data", lstcommunicationgroup);
        Log.out.println("ORGCM224990200", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationGroupServiceImpl", "save", "CommunicationGroup");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
