...
@RestController
@SourceCodeAuthorClass(createdBy = "shweta.zagade1209@gmail.com", updatedBy = "", versionNumber = "1", comments = "Service for Timezone Master table Entity", complexity = Complexity.LOW)
...
public class TimezoneServiceImpl extends TimezoneService {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        responseBean.add("message", String.format(appAlarm.getMessage(), "Timezone"));
        responseBean.add("data", lsttimezone);
        Log.out.println("ORGLM224990200", runtimeLogInfoHelper.getRequestHeaderBean(), "TimezoneServiceImpl", "save", "Timezone");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
