...
@RestController
@SourceCodeAuthorClass(createdBy = "shweta.zagade1209@gmail.com", updatedBy = "", versionNumber = "1", comments = "Service for PasswordAlgo Master table Entity", complexity = Complexity.LOW)
...
public class PasswordAlgoServiceImpl extends PasswordAlgoService {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        responseBean.add("message", String.format(appAlarm.getMessage(), "PasswordAlgo"));
        responseBean.add("data", lstpasswordalgo);
        Log.out.println("ABSUM224990200", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordAlgoServiceImpl", "save", "PasswordAlgo");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
