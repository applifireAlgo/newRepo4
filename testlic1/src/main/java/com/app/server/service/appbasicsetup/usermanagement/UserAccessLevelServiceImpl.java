...
@RestController
@SourceCodeAuthorClass(createdBy = "shweta.zagade1209@gmail.com", updatedBy = "", versionNumber = "1", comments = "Service for UserAccessLevel Master table Entity", complexity = Complexity.LOW)
...
public class UserAccessLevelServiceImpl extends UserAccessLevelService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        ...
        AppAlarm appAlarm = Log.getAlarm("ABSUM224990200");
    ...
    public HttpEntity<ResponseBean> save(@RequestBody UserAccessLevel entity) throws Exception {
        ...
        AppAlarm appAlarm = Log.getAlarm("ABSUM222990200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "UserAccessLevel"));
    ...
    public HttpEntity<ResponseBean> delete(@PathVariable("cid") String entity) throws Exception {
        ...
        AppAlarm appAlarm = Log.getAlarm("ABSUM228990200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "UserAccessLevel"));
    ...
    public HttpEntity<ResponseBean> update(@RequestBody UserAccessLevel entity) throws Exception {
        ...
        AppAlarm appAlarm = Log.getAlarm("ABSUM221990200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "UserAccessLevel"));
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        responseBean.add("message", String.format(appAlarm.getMessage(), "UserAccessLevel"));
        responseBean.add("data", lstuseraccesslevel);
        Log.out.println("ABSUM224990200", runtimeLogInfoHelper.getRequestHeaderBean(), "UserAccessLevelServiceImpl", "save", "UserAccessLevel");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
