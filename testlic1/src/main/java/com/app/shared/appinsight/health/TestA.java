...
@SourceCodeAuthorClass(createdBy = "shweta.zagade1209@gmail.com", updatedBy = "", versionNumber = "1", comments = "TestA", complexity = Complexity.LOW)
@NamedQueries({ @javax.persistence.NamedQuery(name = "TestA.findById", query = "select e from TestA e where e.systemInfo.activeStatus=1 and e.aid =:aid") })
