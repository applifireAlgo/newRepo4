...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainIcon("837MLcbTMizlWCrCqJXVjBLcwMCGnwJHjXong2UfSIuCcn8not");
        useraccessdomain.setDomainHelp("6HSHOnl7awNq6yCnbWg8pqBw0TLygYTP8nQdBLS4LYX9r0kVwT");
        useraccessdomain.setDomainName("xUCZrWv9fpV9NRutlsIfN6joKEF83MWT1TgSeCvqUHDuZvRLMF");
        useraccessdomain.setDomainDescription("y9ethVeIbxHlThpZdJMqLgywGI6hYQcnv1NNfwnYWIoqTsPH1N");
        ...
        useraccesslevel.setLevelName("ND6eql5IsN78hF6oeGWtgxBarafwtDky7KCk05zS4klU4BJWcu");
        useraccesslevel.setLevelHelp("gZeQ4ssc07IRQtWsXn7Qf9cw3W2qX77Q58MzFYp2bgHZ7FmMD6");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelIcon("f0yVtwh9qysnnWHSqVKTfO3NKl4zAHAvhx5Z0yjETftJ9aK8OM");
        useraccesslevel.setLevelDescription("jjC5vHrJ1s1kB11RZDSEfgKMUJW6ilhShStI6GlbUQ7Rs6ldgc");
        ...
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1462446064124l));
        user.setAllowMultipleLogin(1);
        user.setMultiFactorAuthEnabled(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1462446064124l));
        user.setPasswordAlgo("XohFJRSB0nndsl9HYsNdfVDowWZGTISLsO0qRAcxw2lMd2SpP6");
        user.setSessionTimeout(2359);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsDeleted(1);
        user.setIsLocked(1);
        user.setUserAccessCode(30568);
        user.setGenTempOneTimePassword(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionIcon("iHXeZu9MZE2lFT7crvm3POmivUrxNJe2MQPSvNXIpB8mqZUDkd");
        question.setLevelid(10);
        question.setQuestionDetails("X8h8XmMYXO");
        question.setQuestion("FBb9LjrgEfYAHLGdihwN0cs8vJByJA7CpqVPaq5tcxmleXZyHP");
        ...
        passrecovery.setAnswer("0sg26Cfwkwp7TftoSIycvh9FDNm6o9mvxMqhQZ6EYDx7w2wjQK");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setUser(user);
        userdata.setOneTimePassword("WYEQCJeX0uHDhuR5VPVci5C7IaBuQlk7");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1462446064371l));
        userdata.setPassword("yugrTwzg1Ebogbmd62JcS7lZCRt2pac5drZwUjcgPaTFROuidm");
        userdata.setLast5Passwords("D6EL0RgJRbBu8LM0oUpuS1HOieGvT87DcFUJj6vmfd6wB9A9gT");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 77884));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "unzsboJAKlwxorcSdzUAViNe3aCWsWDxSNNQdw4BfIfgs1IASC1cRo03U2OY8wy1S"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 6394));
