...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionIcon("9zJmhIUdiDwCgxX4f7kVjlduprnpD2bGh28eSjrO74iDG4zVRO");
        question.setLevelid(7);
        question.setQuestionDetails("1ANQvl3aBd");
        question.setQuestion("yEco63Dl6pehANnG61k2PXEI2tTITGLoHMA5mkBufLgzN1mk9E");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("JplKBmkRiqU5MsS7ZWd4NIItxUlU9Blu7SLcjWW12Y24Wrh41V");
            question.setLevelid(2);
            question.setVersionId(1);
            question.setQuestionDetails("i13lVi78ML");
            question.setQuestion("ilc9sOQrHqd6x2d6qidwZcBF6OxJICegfFO5XCtxaFCHaIP1uq");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "1jM8i7TeA0Hr6nlWCNUcIdoOjRWIltfNaDOp6Am7oijxFCVbdD06KMI6TSYA1sxbA"));
