 ...
 * 
 */
Ext.define('Testaone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testaone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
