...
Ext
		.define(
				'Testaone.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Testaone.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
