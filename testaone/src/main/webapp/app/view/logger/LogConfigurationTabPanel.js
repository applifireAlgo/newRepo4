...
Ext
		.define(
				'Testaone.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testaone.view.logger.tabs.details.DetailsTab',
							'Testaone.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testaone.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testaone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testaone.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testaone.view.logger.LogConfigurationTabPanelController',
