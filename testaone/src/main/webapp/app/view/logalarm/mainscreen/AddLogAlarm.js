 ...
 * 
 */
Ext.define('Testaone.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testaone.view.logalarm.mainscreen.AddLogAlarmController',
			'Testaone.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testaone.view.logalarm.mainscreen.AppAlarmPanel',
