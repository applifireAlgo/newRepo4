 ...
 * 
 */
Ext.define('Testaone.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testaone.view.logalarm.LogAlarmMainViewController',
			'Testaone.view.logalarm.tree.LogAlarmTreePanel',
			'Testaone.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
