Ext.define('Testaone.view.desktop.design.menubar.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Testaone.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Testaone.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Testaone.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Testaone.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Testaone.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Testaone.view.clouddrive.CloudDrive");
    },
    ...
    onLogoutClick : function(logoutBtn)
    {
     ...
     onSearchClick : function(searchBtn){
         ...
         var searchView = this.pushViewInMainTab("Testaone.view.searchengine.search.SearchEngineMainPanel","Search Result","isSearchCmp","true");
