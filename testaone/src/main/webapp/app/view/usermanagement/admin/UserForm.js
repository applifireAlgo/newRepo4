Ext.define('Testaone.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testaone.view.usermanagement.admin.AddUserDetailsViewModel', 'Testaone.model.AddUserDataModel' ],
