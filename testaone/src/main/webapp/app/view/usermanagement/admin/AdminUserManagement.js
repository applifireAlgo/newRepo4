Ext.define('Testaone.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testaone.view.usermanagement.admin.UserPasswordReset',
	            'Testaone.view.usermanagement.admin.AddUserDetails',
	            'Testaone.view.usermanagement.admin.ViewUser'],
