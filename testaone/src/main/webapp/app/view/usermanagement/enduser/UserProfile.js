Ext.define('Testaone.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Testaone.view.usermanagement.enduser.UserProfileController', 'Testaone.view.usermanagement.admin.AddUserDetailsViewModel', 'Testaone.model.AddUserDataModel' ],
