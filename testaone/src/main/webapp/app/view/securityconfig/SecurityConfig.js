 ...
 * 
 */
Ext.define('Testaone.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testaone.view.securityconfig.SecurityConfigController',
			'Testaone.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
