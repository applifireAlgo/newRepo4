 ...
 */
Ext.define('Testaone.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testaone.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testaone.view.fw.component.DateTimePicker(o);
    },
