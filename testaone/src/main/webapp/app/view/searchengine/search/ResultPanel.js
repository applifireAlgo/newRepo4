Ext
		.define(
				'Testaone.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testaone.view.searchengine.search.SearchEngineMainPanelController','Testaone.view.searchengine.search.PanelHeaderField' ,'Testaone.view.searchengine.search.ReportGridView','Testaone.view.searchengine.search.ReportChartView','Testaone.view.searchengine.search.documentView','Testaone.view.searchengine.search.DouMeanView','Testaone.view.googlemaps.map.MapPanel'],
