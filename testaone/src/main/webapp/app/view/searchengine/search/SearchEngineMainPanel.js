Ext.define('Testaone.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testaone.view.searchengine.search.NorthPanel', 'Testaone.view.searchengine.search.SearchResult','Testaone.view.searchengine.search.SearchEngineMainPanelController'],
