...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccesslevel.setLevelDescription("1g799Gj9fLXqpY8whGNJINj2zypfXNPBo2F45rIECmO6yZ8Ujm");
        useraccesslevel.setLevelName("LxMC7CRXakU18yVgdXVF8BBcEeWxmAkhgF52H4JcE96VzNbMpl");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelIcon("hOMnvDrB3YUtIVMQFK6tiypAdhGyB2rClQCPTZlUrFirOnozoT");
        useraccesslevel.setLevelHelp("aYP0GEPDoKIC0fduO1CgTwgvMbYfPbRjtP68OrSMvvJA6yXgHM");
        ...
        useraccessdomain.setDomainDescription("bCQoc8RV3vhNyqwPoabAXiLojbPY8RnlZMFVvyU2r7TAP2X7Ej");
        useraccessdomain.setDomainName("OBW6aJu6Vjyz6ko41mGItSmfitoPsx66g3tc9fB1DyLK1vZfa0");
        useraccessdomain.setDomainHelp("vL1eLpdtf1uhjl9N6ewYtWWs6HEMjOt6sjV0WUCaSCkxXL2yhz");
        useraccessdomain.setDomainIcon("9M1hN2IALxAdmiWa0Ua3gfQPxlbTCdOGftQeOflkYmQD851KOE");
        ...
        user.setUserAccessCode(660);
        user.setAllowMultipleLogin(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setPasswordExpiryDate(new java.sql.Timestamp(1464961021794l));
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1464961021839l));
        user.setPasswordAlgo("pyaCVkRNFtj7vFGIqFaw6KCHe4270aDg9RSkldFLt5UTtGWSWX");
        ...
        question.setQuestion("CS7K68y547JZlGdyHdiFlEWGOEOm55Wb8AgcVNrNVfpjHYxXsI");
        question.setQuestionDetails("8Ce3kBkFOB");
        question.setQuestionIcon("wtoPhNCa3xEi0IfijuoGTbysiQOC8HGLy7o16QVzNhSKiH3t1W");
        ...
        passrecovery.setAnswer("CIZJg4H2U6J5qfV4ql1ADXGXs2LBcyIGsLDYYJyCJKuSfwDO1d");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setLast5Passwords("xUcw4CaREWh14kBIpVSMxY8ixlgSww9trF64TMXbkAu4Q0TW4p");
        userdata.setOneTimePassword("icwnPu9MT5mbvqFVud9ro5VsTheZvbJd");
        userdata.setOneTimePasswordExpiry(5);
        userdata.setPassword("INRdxHDIMcGn6eo5dTOoRxkd7AXLcCe2DFlwn6ZLa0oZ6SVPpn");
        userdata.setLast5Passwords("1ZBQ05j3ibHYk7DcMueneD50AlaVynV1hN4TRgFmSlJNSnUamH");
        userdata.setOneTimePassword("z97THNxeLbaktPQKg6e3g1DcF74k4Y8v");
        userdata.setOneTimePasswordExpiry(4);
        userdata.setPassword("MRmZoyfWCdo0kEFcERO3M61oaZDZpE6MmzW7q3MmOD5V4zVPhZ");
        userdata.setUser(user);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1464961022065l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 88077));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "OtqjpJM4aiQzIW7Bq0dQzAccDwUypnHFCBmXbvaqCsrzRRRAbPVDOMtf5Urt1E8LC"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 6914));
