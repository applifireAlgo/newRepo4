...
public class CommunicationTypeTestCase extends EntityTestCriteria {
    ...
    private CommunicationType createCommunicationType(Boolean isSave) throws Exception {
        ...
        communicationgroup.setCommGroupName("5gzzpbmgZjeseuidJXXEAmLsC8hljVKYAM71Ajv5yYiXJ6i5fP");
        communicationgroup.setCommGroupDescription("FAEqKBpqjoUIUPrSAl9JI4jaixzNvRYrP3DO37Wei9WzKrylIP");
        ...
        communicationtype.setCommTypeName("mvkc1exlyzwoXqXSKusq9BCw5496GBTQPD6IKJRi96d5CJybQI");
        communicationtype.setCommTypeDescription("KKaZJyyPhPedDgiWwO8hogC2A6wVKpbp0xTbhS54rjsbG9UJ9Y");
    ...
    public void test2Update() {
        try {
            ...
            communicationtype.setCommTypeName("EeAiDXZDGC4ykMU94jSRW0RM37vqcEwirJWSnNuuAPzygBpGEy");
            communicationtype.setCommTypeDescription("98qzVSkQ8c1mMpyHQI4E8ZXGloJpxiS9EC1EPUvC72jfQ8zh6t");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commTypeName", "ElpOOSQYJiulzR7lPNpZZLD3aekcVtoifrEYDgndiqqw3VkEZ2QdvAujYBrVvimfwaKU5j1XE4pP1w97xuykVW54UXmtpg9gxbNCtd2MOWO9wLxaZBw1u2VeRgWA4clkY"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commTypeDescription", ""));
