...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestion("rSUgWwXFgoVTMIcnX6ixdsFmkTZcw1kSVKilBQwFPcKqOJP2w9");
        question.setQuestionDetails("1mBcQ7HY8F");
        question.setQuestionIcon("MUzztVHbpX5gjCHLaa4TyPIgyLgAZh8HnqdG3bbVMFaGt8Xxkw");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("7SG8RiKN6RVpxSojqimyle1MV1MZjDthgc4wuaNRLuwCx1BsGc");
            question.setQuestionDetails("zokH4TLbsT");
            question.setQuestionIcon("tmRzNaXkMP6ap2Va8FgOMWLH7tk1gs2IYwSX8ctTSUFAIlRO67");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "5Dcqdxwx0nBe6a0vjePdWlVrumLlpyntyD9o1V8UqhIoOYLE1Lnfp0Jae68rFeu90"));
