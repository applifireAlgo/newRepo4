...
public class EmpTestCase extends EntityTestCriteria {
    ...
    private Emp createEmp(Boolean isSave) throws Exception {
        Emp emp = new Emp();
        emp.setEmpName("H14zvf777J1FFrjQx2o161GeKtBtWo6T8rg7Em8V3EF5ytuGds");
        emp.setDob(new java.sql.Timestamp(1464961033024l));
    ...
    public void test2Update() {
        try {
            ...
            emp.setVersionId(1);
            emp.setEmpName("ENNhCQsT0krtmLQsGvMMarKpkgatrXNHsDN1g7qzw3jQho3sw9");
            emp.setDob(new java.sql.Timestamp(1464961033051l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "empName", ""));
