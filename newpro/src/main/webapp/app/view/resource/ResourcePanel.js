Ext.define('Newpro.view.resource.ResourcePanel', {
	...
	title:'<p style="color:#fff;font-weight:bold;font-size:20px;margin:0px;padding:0%;"><img src="images/logo.png" width="60" height="60" align="center" hspace="5" style="border-radius:60%;">NewPro</p>',
    resizable:false,
    overflowY:'auto',
	listeners:{
		scope:'controller',
