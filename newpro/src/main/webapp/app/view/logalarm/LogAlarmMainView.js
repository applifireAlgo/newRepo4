 ...
 * 
 */
Ext.define('Newpro.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Newpro.view.logalarm.LogAlarmMainViewController',
			'Newpro.view.logalarm.tree.LogAlarmTreePanel',
			'Newpro.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
