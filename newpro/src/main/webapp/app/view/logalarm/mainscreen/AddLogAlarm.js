 ...
 * 
 */
Ext.define('Newpro.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Newpro.view.logalarm.mainscreen.AddLogAlarmController',
			'Newpro.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Newpro.view.logalarm.mainscreen.AppAlarmPanel',
