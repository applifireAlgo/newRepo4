Ext.define('Newpro.newpro.web.com.controller.appinsight.health.TestAMainController', {
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#TestAGrid');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#TestAForm').down('#' + me.column.dataIndex + '').store;
