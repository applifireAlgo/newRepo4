...
public interface TtwoRepository<T> extends SearchInterface {
    ...
    public List<T> findByTonenm(String tonenm) throws Exception;

    public T findById(String tteoId) throws Exception;
}
