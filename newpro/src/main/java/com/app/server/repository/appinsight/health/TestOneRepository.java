...
public interface TestOneRepository<T> extends SearchInterface {
    ...
    public List<T> findByAaa(String aaa) throws Exception;

    public T findById(String ttid) throws Exception;

    public List<T> TOneNamtiveQ(String ttid) throws Exception;
}
