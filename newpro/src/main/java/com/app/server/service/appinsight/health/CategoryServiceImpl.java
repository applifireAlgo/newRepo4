...
@RestController
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Service for Category Master table Entity", complexity = Complexity.LOW)
...
public class CategoryServiceImpl extends CategoryService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.app.shared.appinsight.health.Category> lstcategory = categoryrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByBrandnm(@RequestBody FindByBean findByBean) throws Exception {
        ...
        List<com.app.shared.appinsight.health.Category> lstcategory = categoryrepo.findByBrandnm((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("AISHI124100200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Category"));
        responseBean.add("data", lstcategory);
        Log.out.println("AISHI124100200", runtimeLogInfoHelper.getRequestHeaderBean(), "CategoryServiceImpl", "save", "Category");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        com.app.shared.appinsight.health.Category lstcategory = categoryrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("AISHI124100200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Category"));
        responseBean.add("data", lstcategory);
