...
public abstract class TestOneService {
    ...
    public HttpEntity<ResponseBean> findByAaa(FindByBean findByBean) throws Exception {
        return null;
    }
    ...
    public HttpEntity<ResponseBean> TOneNamtiveQ(String ttid) throws Exception {
        return null;
    }
}
