...
@Table(name = "ast_TestA_M")
@Entity
@Cache(type = CacheType.CACHE)
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "shweta.zagade@algorhythm.co.in", versionNumber = "6", comments = "TestA", complexity = Complexity.LOW)
@NamedQueries({ @javax.persistence.NamedQuery(name = "TestA.findById", query = "select e from TestA e where e.systemInfo.activeStatus=1 and e.aa =:aa"), @javax.persistence.NamedQuery(name = "NamedAQ", query = "SELECT testA FROM TestA AS testA ") })
