...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestion("uWNVE7FWqQZ56tDiJ3cC2TM4SBikzcxtD1X2dqUM6xU8iTcAUS");
        question.setQuestionDetails("A49ijSEXq0");
        question.setQuestionIcon("VR8SHee8FRah2ObksaP4mXv8hVY413gaEP1AevQuFGgzEh5JR5");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("X3nwWDFunqPParymqn9TlZUlC2cuWKsZpVvl5x1PW1GGcPoNYU");
            question.setQuestionDetails("i13lpUce87");
            question.setVersionId(1);
            question.setQuestionIcon("MuuS5QmWE0clcEXvonAMlowGTCEml9uRITcNxcfuc7Lqv5xPwu");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "hxhUr4Cy3CrzUpySkManI0hmzHEGQjrsow6TcJLYmokvMSanqkjiH2hFerzZmiyYO"));
