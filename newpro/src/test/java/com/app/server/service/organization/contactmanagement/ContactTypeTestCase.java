...
public class ContactTypeTestCase extends EntityTestCriteria {
    ...
    private ContactType createContactType(Boolean isSave) throws Exception {
        ...
        contacttype.setContactType("e0n08nRX1wYJ4hOD0Pz4wrDhG6id2ORGPT1Xt1FmsJkdRywUkA");
        contacttype.setContactTypeDesc("CXCx0w49KUEHdwFcSFHV0eU2e1lOrPZksrFxzfzz2iks09yNwU");
        contacttype.setContactTypeIcon("eK1PTSPfu3dNbQu1B5Enb5lLSnurYUo5gptDDnzjCjQdQXjtEx");
    ...
    public void test2Update() {
        try {
            ...
            contacttype.setContactType("beZAOVb8LLTtWQLJQm78JrIAg0lKYKgGwP4T4WlLrvVLTJw6Q5");
            contacttype.setContactTypeDesc("GVf7EGf9Tw2LysrLw6mW4eBzTqjFdoSyJ7pD9KGCGxsDv7cXM9");
            contacttype.setVersionId(1);
            contacttype.setContactTypeIcon("FapSzScYflCPtZ01WudCdCnCmSzrFcU3AG9CGIoGRh96VoxqsY");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "contactType", "8hbySqTUhLymMdmcuUgYpZYsOBYp1f139ZCQYpBFBJwuoGhuuMqcpYHYtuS7dGMrrGdf0expdDztetyOAyWnCuBJ3ymqHGeY8jqTmaOgCo0y8Et9mQT8u5Fs67yzb5I74"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "contactTypeDesc", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "contactTypeIcon", "NdAf9ciV9edENC2HIMpg49RQNqb0ZrGd0DnQMwZUG91lmfAh43isR0mrtU2LG56ITQ1Z8FJBUrpGd6ch9iNWgw3dzpy5TjWbpLOlAlTu3wLhxsTNEC8eiCw6D44H99ft4"));
