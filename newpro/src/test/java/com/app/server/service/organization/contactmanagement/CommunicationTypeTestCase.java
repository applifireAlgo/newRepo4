...
public class CommunicationTypeTestCase extends EntityTestCriteria {
    ...
    private CommunicationType createCommunicationType(Boolean isSave) throws Exception {
        ...
        communicationgroup.setCommGroupDescription("Oepkc7pcAXHtZfaiXvcBlGX28RHevm4ok97GJKfWctUgMtPmh4");
        communicationgroup.setCommGroupName("RS2UhH4Bpyk7MWSn8XV9RqWoOVWYZ1M9bw8iAvK5VRTwMKcXsg");
        ...
        communicationtype.setCommTypeDescription("S9ZbFxbIBJO807JLjqAE26A9kC7AJmraxvq7oZDmYA9oEz8OrC");
        communicationtype.setCommTypeName("H6Xku43VdXPer4PTRgt2eE2Zn9FgXYmkGD57c7S8jpjoHSVtWy");
    ...
    public void test2Update() {
        try {
            ...
            communicationtype.setCommTypeDescription("vB9ILJcMAlQakutrbMBxnY8W2sAkCZGhjv5P0SwnSzpew9ZEyQ");
            communicationtype.setVersionId(1);
            communicationtype.setCommTypeName("J3qYxyjAhVpUtAkwzBGDJ6SCw1cCfR49YabJgKw5mkl3NJY48Z");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commTypeName", "avtOgGM6nPSSpWqtycDxpSLGQniWWCPQteeoEvwO6JvSAzb8UT0Cmc8zTmMM6VCYR4ZiemA3u3SFAeKHIGKBxcc7CXCXq4FpfPD0A4o2uxTPf9a7BT6FQiwvK8R3cqW1N"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commTypeDescription", ""));
