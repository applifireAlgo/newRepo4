...
public class TestATestCase extends EntityTestCriteria {
    ...
    private TestA createTestA(Boolean isSave) throws Exception {
        ...
        testa.setAnm("Re1bJrbALo0LjSQDPVFOfRsbZjBgRSscWNIHLVAomdIpK9DPaI");
        testa.setaDate(new java.sql.Timestamp(1463049394138l));
    ...
    public void test2Update() {
        try {
            ...
            testa.setAnm("92QU3nRlNzg76w8YtH68JoFFcxYxCQp8MqjVGuCaCoZzVCD1e9");
            testa.setVersionId(1);
            testa.setaDate(new java.sql.Timestamp(1463049394152l));
            testa.setAno(2147483647);
    ...
    @Test
    public void testNQNamedAQ() {
        try {
            testaRepository.NamedAQ();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "anm", ""));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 3, "ano", null));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 4, "aDate", null));
