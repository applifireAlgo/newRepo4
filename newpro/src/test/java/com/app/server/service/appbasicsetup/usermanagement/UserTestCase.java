...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccesslevel.setLevelDescription("0ZgU416xulHRIWighGlVyiIzUtSn0Sy6CustxYgCJ006JPV2ra");
        useraccesslevel.setLevelName("NIpfvxdtu1v24yutUqow6uMRBXKIIP3ZitLYOgDB8cGVGnkSlN");
        useraccesslevel.setLevelIcon("NWMrVLIInHY34BbcpFAaeGbR61OlBU1k3aWdO6h6LwcOIaUAfi");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelHelp("gDlZLc5efA3wJuzcmf7leUBjY435q0SK3CXRAiQrIkwaaae32b");
        ...
        useraccessdomain.setDomainDescription("fBTVstYy08s2GichsfD43u7kfdxnfkeH6Vkj1E3LtQsVFO4eln");
        useraccessdomain.setDomainIcon("JkLHgjQ7XALveyr2IMyk3kvuzI4ZxEg82nsANLi5zZRpIuFlpg");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainHelp("lju7w6miDf8b9FF6ZrtbTdIeV0ybQrAc3jry2Br9YWXpcTWaJ9");
        useraccessdomain.setDomainName("yErfZXW7Gr8CUUtLjX1Ogn2heZgd71lq8HsaYfEUlBblJ48nMe");
        ...
        User user = new User();
        user.setPasswordExpiryDate(new java.sql.Timestamp(1463048454898l));
        user.setSessionTimeout(3112);
        user.setChangePasswordNextLogin(1);
        user.setIsLocked(1);
        user.setUserAccessCode(54435);
        user.setAllowMultipleLogin(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1463048454899l));
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsDeleted(1);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setPasswordAlgo("H6GlsgaLRxUzQvnC9c5eW6lPEnsjAn8INUoZJgfn2EnmD5p38y");
        ...
        question.setQuestion("v6mImriGVuMlaSFjm5OSqwdrgB37g0mwyk5GpwRp8k6PjUEaUB");
        question.setQuestionDetails("4BNqefwMFC");
        question.setQuestionIcon("b4RidXHelol4XpP4dCKnFuKmOFyxsPa8I5HyZnPRG8VFIEtyiK");
        ...
        passrecovery.setAnswer("NruViPsIjy9FFuFH19aVVpkE4d9ud3BSuTGFkjOdGCPBnqCTtv");
        ...
        userdata.setLast5Passwords("7gcCDi41nxIbSfJDZKzAAQ72WYarmJQvchzKgYOhzO5WLP3Ozx");
        userdata.setOneTimePassword("hcCichZFH3Mz6mRzfZmIn68u1dVI4gNL");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1463048455179l));
        userdata.setPassword("KbLbR2MM4VE4cb3QXD319V421Mg1F3SMerl5dyiUk5leaSPC00");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 103524));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "1KpRrOKIpu6astUv7WiTGOXCFrYUaOlfBDzR9CZcZHRKZXIbDX5SC8qTIQG4s1Ocw"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5600));
