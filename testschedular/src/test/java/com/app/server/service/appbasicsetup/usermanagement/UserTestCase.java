...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccesslevel.setLevelHelp("vbGtIY7ci9OA5Yoabn7ycE1bF6Hw8UvL6RAt3naQKIfX3tLWDV");
        useraccesslevel.setLevelIcon("pl05w1odsZHFmJp0Tw2oQT6zSSe1kJco7UFuXBd8YduoOmjYnm");
        useraccesslevel.setLevelName("tYIHbbKZscIFF3TRYifqY3Jma1kieuqzxmKtPNlF24wFhXQMD4");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelDescription("LynRBEwacU32xamYJ3TEWH9fREtOGgiyBfYs2KVFB1Kjwj2fSE");
        ...
        useraccessdomain.setDomainDescription("ytFxvmVKB9kurRsShANMfk6Gbzz50JkmHAL7KeDgQMtAW1GYm0");
        useraccessdomain.setDomainHelp("KgUvC9WvKkQ1i9NQDM49ir9gqA6LFlRjdRQcH0SQNI2TuBaLLB");
        useraccessdomain.setDomainIcon("JqjrNCI6uNeSqmwEhuiFg1qceep3eeliSSj8oFd7CUaxRKzZ6z");
        useraccessdomain.setDomainName("6QypUIZuXrwH0fFPtjWDAmyq578c7GwMc3HPjxbPWnVZURkiMb");
        ...
        user.setPasswordAlgo("pwy6FjxQkyMRJg2ymkuXcN9ZCGmBLNGKkzAFXHVvKqxyHTjjHm");
        user.setIsLocked(1);
        user.setMultiFactorAuthEnabled(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setPasswordExpiryDate(new java.sql.Timestamp(1463642655803l));
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setGenTempOneTimePassword(1);
        user.setUserAccessCode(49111);
        user.setSessionTimeout(2488);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1463642655838l));
        user.setIsDeleted(1);
        user.setChangePasswordNextLogin(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionDetails("1vJlgtw5VT");
        question.setQuestion("iWhpbJgslmqVUVoezKi5qC2Imoehul8do2vVscRyXvPKVUKEni");
        question.setLevelid(1);
        question.setQuestionIcon("rK80HHjwzAGznw1wQwwNRCggOaYZ7CoWhvtUC3zsl0TU6l7M4I");
        ...
        passrecovery.setAnswer("DDf8izfDzDzsmVv2hvgj6cczYlstF3o7MWwbUfpVLAj0i7RSDi");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePassword("ozcMBH7Uvxt1CmwZuDwl28VozL4mLDSV");
        userdata.setPassword("Oh1UIoT6XD8OEEnuCXqbyOryF0q300JmVzzvAGHkLktxfOiFpv");
        userdata.setOneTimePasswordExpiry(9);
        userdata.setOneTimePassword("GHsXaF5VQ2KIHQCRRep28IEDRlZvTihi");
        userdata.setPassword("jdIEqo5SapLHJWk0eN58vyCvtGcdEPRCzWKHBzl6n1VQmHMdIe");
        userdata.setOneTimePasswordExpiry(9);
        userdata.setUser(user);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1463642656035l));
        userdata.setLast5Passwords("Qxx3OQniHIikO0qtOBl4tBFLh7m5M3VsQp2qBa2nmyOem9KwVA");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 109917));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "yqKtgbmWUujkzoKX5xQqeuRwIiAezD15lcxR6BvlfWLV5DvhhBgPlY9xIJ1WYZ2YA"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 4398));
