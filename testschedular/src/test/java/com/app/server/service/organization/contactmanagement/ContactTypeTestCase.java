...
public class ContactTypeTestCase extends EntityTestCriteria {
    ...
    private ContactType createContactType(Boolean isSave) throws Exception {
        ...
        contacttype.setContactTypeIcon("4aTVVY59TcdNrleUqhTzbJoSayfEQe3vbmqgERHHTqlIUUP6t5");
        contacttype.setContactTypeDesc("e0YNjwiMhrH9mIFrH9u66tYkY52mP68wuHrZZ2hRuurcBBhpmk");
        contacttype.setContactType("pkqAcKeZWQDuG1HXo4Jm8vwxC8Bs5XtArjkBYQMxSEbyKAPZbN");
    ...
    public void test2Update() {
        try {
            ...
            contacttype.setContactTypeIcon("kR0mRIS2TscIJryuTVKENcpxUwJPNug9QmSiAw339pr1D7w3nX");
            contacttype.setContactTypeDesc("pKZWvwGjJeerJpCm5q9tNulHB2oclynVDlYXa0n6MR6ReyQw6I");
            contacttype.setContactType("GnnHQx8OFQNmMHvVL5LGfWHLDhhAkqcgpZl3Pea3qMF2Ok60yb");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "contactType", "u5SRjYM1zkeIDiTlugyX0Nnbsiw0n15AU00aHuudwxctmkRhzCWJdSx3cBCFRtTzcteE793Iz804vHnIM3lkOqGc2CeDFcbyitfzMkx4k8RaRVykuvmmGCOKjWmjofBN5"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "contactTypeDesc", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "contactTypeIcon", "qUm32H11Lwq1zqqYBbWL6ofk1JjEWkFbXR9tWlT55LL9YCjiaD7XaozYlXDExtSnZhWx6A2IdCzi9LZO9xpkSlTNkLwCDoRSEWs47U8PzELMa7AqVPHdjHZ1PNngCxbhJ"));
