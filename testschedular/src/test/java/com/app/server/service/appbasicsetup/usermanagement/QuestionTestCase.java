...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("gYZJZQm3hx");
        question.setQuestion("GKkX9CcCCcc7nEJnt1QlXsPze1tBJCX2csQf2uX7RZeToX1SZD");
        question.setLevelid(5);
        question.setQuestionIcon("LDG04hATYHf0MBvxQmtxhAOGy7bp7Ts8bMgecO2zsc9hhdaA6Y");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("qBYa6A4E62");
            question.setVersionId(1);
            question.setQuestion("OiH9WcFnQ8uLZErxYVVynH1RvaAw2Ecyjc3Ig2jnKQTSQ4FCyd");
            question.setLevelid(8);
            question.setQuestionIcon("b1miKTpbDoTRwXhfXAdQu2nxojhZ9e6DlX1qoHCRlmd8fJdVVD");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "rcbpJEokSO45dzozBEQjfSKFXPkBmVDZevvHsqpUPspUMAX1fU0RaKxsUchf5XcB2"));
