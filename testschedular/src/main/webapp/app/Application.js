 ...
 */
Ext.define('Testschedular.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Testschedular.view.databrowsercalendar.DBCalendar"],
	...
	stores : [ 'Testschedular.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Testschedular.view.login.SessionLogin').center();
