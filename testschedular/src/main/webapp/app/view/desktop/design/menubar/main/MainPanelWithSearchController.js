Ext.define('Testschedular.view.desktop.design.menubar.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Testschedular.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Testschedular.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Testschedular.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Testschedular.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Testschedular.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Testschedular.view.clouddrive.CloudDrive");
    },
    ...
    onLogoutClick : function(logoutBtn)
    {
     ...
     onSearchClick : function(searchBtn){
         ...
         var searchView = this.pushViewInMainTab("Testschedular.view.searchengine.search.SearchEngineMainPanel","Search Result","isSearchCmp","true");
