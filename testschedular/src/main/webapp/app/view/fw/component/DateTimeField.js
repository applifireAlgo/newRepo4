 ...
 */
Ext.define('Testschedular.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testschedular.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testschedular.view.fw.component.DateTimePicker(o);
    },
