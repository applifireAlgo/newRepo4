Ext.define('Testschedular.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testschedular.view.searchengine.search.NorthPanel', 'Testschedular.view.searchengine.search.SearchResult','Testschedular.view.searchengine.search.SearchEngineMainPanelController'],
