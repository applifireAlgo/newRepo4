Ext
		.define(
				'Testschedular.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Testschedular.view.searchengine.search.documentController',
							'Testschedular.view.searchengine.search.RowExpander' ],
