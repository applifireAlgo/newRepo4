Ext
		.define(
				'Testschedular.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testschedular.view.searchengine.search.SearchEngineMainPanelController','Testschedular.view.searchengine.search.PanelHeaderField' ,'Testschedular.view.searchengine.search.ReportGridView','Testschedular.view.searchengine.search.ReportChartView','Testschedular.view.searchengine.search.documentView','Testschedular.view.searchengine.search.DouMeanView','Testschedular.view.googlemaps.map.MapPanel'],
