 ...
 * 
 */
Ext.define('Testschedular.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testschedular.view.logalarm.mainscreen.AddLogAlarmController',
			'Testschedular.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testschedular.view.logalarm.mainscreen.AppAlarmPanel',
