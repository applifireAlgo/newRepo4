 ...
 * 
 */
Ext.define("Testschedular.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Testschedular.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
