 ...
 * 
 */
Ext.define('Testschedular.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testschedular.view.securityconfig.SecurityConfigController',
			'Testschedular.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
