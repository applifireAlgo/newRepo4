 ...
 * 
 */
Ext.define('Testschedular.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Testschedular.view.logger.tabs.fileconnector.FileConnectorTabController'],
