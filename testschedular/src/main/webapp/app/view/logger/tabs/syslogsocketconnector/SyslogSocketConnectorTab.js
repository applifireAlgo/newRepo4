 ...
 * 
 */
Ext.define('Testschedular.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testschedular.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
