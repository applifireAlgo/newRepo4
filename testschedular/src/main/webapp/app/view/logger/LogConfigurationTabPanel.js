...
Ext
		.define(
				'Testschedular.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testschedular.view.logger.tabs.details.DetailsTab',
							'Testschedular.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testschedular.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testschedular.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testschedular.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testschedular.view.logger.LogConfigurationTabPanelController',
