...
Ext.define('Testschedular.view.databrowsercalendar.DBCalendarController', {
	...
	getReportData:function(){
		...
		var response = this.syncAjaxPOSTCall('secure/reportViewController/getReportDetailsById?reportId='
						+ panel.refId, '');
	...
	openDrillReport:function(reportid,name,qccriteria){
		...
		var component= Ext.create('Testschedular.view.appreportui.ReportView', {
					closable : true,
					drilled : true,		
					title :name,
					refId : reportid,
