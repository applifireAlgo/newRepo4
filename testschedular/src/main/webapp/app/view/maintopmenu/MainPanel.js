Ext.define('Testschedular.view.maintopmenu.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithTopMenu',

	requires : ['Testschedular.view.maintopmenu.TopPanel',
				'Ext.layout.container.Accordion', 
				'Ext.Img',
				'Ext.button.Split',
				'Testschedular.view.fw.mainViewPanel.MainPanelController' ],
