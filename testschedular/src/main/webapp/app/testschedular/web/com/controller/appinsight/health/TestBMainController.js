Ext.define('Testschedular.testschedular.web.com.controller.appinsight.health.TestBMainController', {
     extend: 'Testschedular.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.TestBMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#TestBTree');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#TestBForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#TestBGrid');
               var tree = this.view.down('#TestBTree');
               if (method == 'PUT') {
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#TestBForm');
          var grid = this.view.down('#TestBGrid');
          var tree = this.view.down('#TestBTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#TestBGrid');
               ...
               var formPanel = this.getView().up().down('#TestBForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#TestBTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#TestBForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#TestBGrid').store;
          gridStore.removeAll();
