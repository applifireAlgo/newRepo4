Ext.define('Testschedular.testschedular.web.com.controller.appinsight.health.EmpMainController', {
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#EmpGrid');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#EmpForm').down('#' + me.column.dataIndex + '').store;
