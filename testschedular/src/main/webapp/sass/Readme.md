...
folder are mapped to the application's root namespace, 'Testschedular'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Testschedular"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Testschedular' in the same way
as `"Testschedular/sass/src"`.
