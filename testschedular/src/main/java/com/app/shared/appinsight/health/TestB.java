...
@Table(name = "ast_TestB_M")
@Entity
@Cache(type = CacheType.CACHE)
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "TestB", complexity = Complexity.LOW)
@NamedQueries({ @javax.persistence.NamedQuery(name = "TestB.findById", query = "select e from TestB e where e.systemInfo.activeStatus=1 and e.aid =:aid") })
