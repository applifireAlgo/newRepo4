...
@Table(name = "ast_Emp_M")
@Entity
@Cache(type = CacheType.CACHE)
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Emp", complexity = Complexity.LOW)
@NamedQueries({ @javax.persistence.NamedQuery(name = "Emp.findById", query = "select e from Emp e where e.systemInfo.activeStatus=1 and e.empId =:empId") })
