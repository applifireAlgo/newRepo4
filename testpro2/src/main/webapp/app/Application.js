 ...
 */
Ext.define('Testpro2.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Testpro2.view.databrowsercalendar.DBCalendar"],
	...
	stores : [ 'Testpro2.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Testpro2.view.login.SessionLogin').center();
