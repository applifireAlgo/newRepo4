Ext.define('Testpro2.view.appreportui.chart.ChartViewController', {
			...
			if(chart[i].hasOwnProperty("group")&& chart[i].group==true){
				this.getView().add({xtype:'groupChartPanel',"groupChartJson":chart[i].groupCharts,
							...
							tbar:{
								...
								items:[{xtype:'displayfield',value:chart[i].chartTitle,fieldStyle:{fontWeight:"bold",fontSize:"16px",fontColor:"#424242"}}],style:{ background:"#f6f6f6"}
							},
							margin:10,
