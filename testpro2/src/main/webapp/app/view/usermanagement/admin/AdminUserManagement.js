Ext.define('Testpro2.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testpro2.view.usermanagement.admin.UserPasswordReset',
	            'Testpro2.view.usermanagement.admin.AddUserDetails',
	            'Testpro2.view.usermanagement.admin.ViewUser'],
