Ext.define('Testpro2.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testpro2.view.usermanagement.admin.AddUserDetailsViewModel', 'Testpro2.model.AddUserDataModel' ],
