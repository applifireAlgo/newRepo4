 ...
 */
Ext.define('Testpro2.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testpro2.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testpro2.view.fw.component.DateTimePicker(o);
    },
