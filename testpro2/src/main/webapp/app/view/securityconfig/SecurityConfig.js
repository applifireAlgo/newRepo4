 ...
 * 
 */
Ext.define('Testpro2.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testpro2.view.securityconfig.SecurityConfigController',
			'Testpro2.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
