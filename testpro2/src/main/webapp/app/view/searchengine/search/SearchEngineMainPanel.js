Ext.define('Testpro2.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testpro2.view.searchengine.search.NorthPanel', 'Testpro2.view.searchengine.search.SearchResult','Testpro2.view.searchengine.search.SearchEngineMainPanelController'],
