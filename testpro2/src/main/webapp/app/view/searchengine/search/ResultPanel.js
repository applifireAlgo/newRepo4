Ext
		.define(
				'Testpro2.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testpro2.view.searchengine.search.SearchEngineMainPanelController','Testpro2.view.searchengine.search.PanelHeaderField' ,'Testpro2.view.searchengine.search.ReportGridView','Testpro2.view.searchengine.search.ReportChartView','Testpro2.view.searchengine.search.documentView','Testpro2.view.searchengine.search.DouMeanView','Testpro2.view.googlemaps.map.MapPanel'],
