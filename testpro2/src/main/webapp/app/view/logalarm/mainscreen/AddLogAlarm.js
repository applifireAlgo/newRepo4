 ...
 * 
 */
Ext.define('Testpro2.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testpro2.view.logalarm.mainscreen.AddLogAlarmController',
			'Testpro2.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testpro2.view.logalarm.mainscreen.AppAlarmPanel',
