 ...
 * 
 */
Ext.define('Testpro2.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testpro2.view.logalarm.LogAlarmMainViewController',
			'Testpro2.view.logalarm.tree.LogAlarmTreePanel',
			'Testpro2.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
