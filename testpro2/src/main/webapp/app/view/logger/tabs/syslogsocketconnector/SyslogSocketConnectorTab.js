 ...
 * 
 */
Ext.define('Testpro2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testpro2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
