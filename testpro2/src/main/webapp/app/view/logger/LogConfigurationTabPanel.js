...
Ext
		.define(
				'Testpro2.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testpro2.view.logger.tabs.details.DetailsTab',
							'Testpro2.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testpro2.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testpro2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testpro2.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testpro2.view.logger.LogConfigurationTabPanelController',
