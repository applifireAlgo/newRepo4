...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainDescription("lutkHuYL05KhNwaMWFyDG2Nval18SPEPtto2xRxLMTe4BkGMKL");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainName("nhiN0NXO6YffKL93lFjJqc7armwxFTy8ErRHjovvcmbwk2Omiu");
        useraccessdomain.setDomainIcon("psQhwSm2S1jSkK8NJrgqhWdjkAfTF3pXv96yqHBKX42oJ8l5Hu");
        useraccessdomain.setDomainHelp("jOPb9burigVYOkN5Af0Vjan0oCTsXci7cuA2mwtFLnxtVcRR8F");
        ...
        useraccesslevel.setLevelName("BE3JgNJLcjLnqe0DsZmrC4mIWRkfuSrSXdjqs0MBlF7t4TWWV4");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelHelp("OgzPrpDKeFCaWblamlDRWoDXl8TKZ9Nhth9XdPJ35tluv5RojX");
        useraccesslevel.setLevelDescription("bjPaNNwLt1TDiqnQEkTy7HecPakIVvoBWv0Bmi8dF1HsZR1Cqp");
        useraccesslevel.setLevelIcon("wmQiesj6a60t47RmLhsYm7V1JzMMjg3BzhiGfIM7Umd3scJQ5s");
        ...
        User user = new User();
        user.setPasswordExpiryDate(new java.sql.Timestamp(1463035428161l));
        user.setIsDeleted(1);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setPasswordAlgo("pGcKQafan21AG3GiwFufclpc2cGtnQpVaVuYktm43CItVCpzUq");
        user.setChangePasswordNextLogin(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1463035428193l));
        user.setUserAccessCode(39746);
        user.setIsLocked(1);
        user.setMultiFactorAuthEnabled(1);
        user.setAllowMultipleLogin(1);
        user.setGenTempOneTimePassword(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setSessionTimeout(2492);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionDetails("XfS2G6obZs");
        question.setLevelid(3);
        question.setQuestion("46Ah7W7fMtqpbAYVChzagtr5ZuBLqwZalLpAXXUDBeiEs6pCex");
        question.setQuestionIcon("p7LO3gx0gocaxIkwRA6ooJAa7Yp62IiMDkSxM9BriuLXnYPcfe");
        ...
        passrecovery.setAnswer("LJ73cBlIQLqTC5KFys81kyxeoLB20sZ6MEbXzQKt6lWBmcSwAJ");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePassword("xccqke07AihCcDkI48WqJCTTMwUd2TZv");
        userdata.setLast5Passwords("ucBzbHQnghdLPADTtg3aFjkIIlm8770cv97Cbq7tttnxIdaQFc");
        userdata.setPassword("kJGHRq5XAVF0swChw41LstcYzSVwHQQe1zBhxL0GNf7AeZjdUS");
        userdata.setOneTimePasswordExpiry(7);
        userdata.setOneTimePassword("Flg28HATbZv0662lvzYEzZYIVQNP44nV");
        userdata.setLast5Passwords("clgUtGL7xIADG9oWUQlfADX9ADontr7RadHGvjgApisP2rfj0B");
        userdata.setPassword("jEzLBHS4DRtyOp5CYH1n6rXwknOMOfeel9l32NexbGkThjuXCK");
        userdata.setOneTimePasswordExpiry(4);
        userdata.setUser(user);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1463035428449l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 67895));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "UMDdwzeJkifFXakUht1HVfKt88DVIoR8qcSbDZ4ZIl69PwlkJL8OVdbbtyQ7kwi7p"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5766));
