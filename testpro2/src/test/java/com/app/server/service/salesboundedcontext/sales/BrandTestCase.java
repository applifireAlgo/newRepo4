...
public class BrandTestCase extends EntityTestCriteria {
    ...
    private Brand createBrand(Boolean isSave) throws Exception {
        ...
        category.setCategory("gID6PCOPmdXN8dl0zHiWkD9rEAma7DRz2npdlAcVruwLhvhAGt");
        ...
        brand.setBranddesc("g9fXWFCUUVYOMLDyMz6dUVTTEBk0UYeACcBO5XnNsgcCdD5cWL");
    ...
    public void test2Update() {
        try {
            ...
            brand.setBranddesc("POWwYjCe1ch4xkRoyIJ1sTrRvPtPSSQrQnsi0LbcQgLXWf3Ii6");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "branddesc", "s1H8VQXLjKqtMvj3qTFwZLGnJR8jGjDnz2KElwWIK0y7lYio9mG5wEHTtDbZyn5DC"));
