...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("OblUFQuIW4");
        question.setLevelid(8);
        question.setQuestion("EIcvAHxk6EKZzSdgYjuu1MQSkwo6loqLwJzq6jJk5dhiV10MIC");
        question.setQuestionIcon("BRZxqMupY5tLkLBgBYRfCCNVNsIxeaFkswJqSOGN6RGYdqzfFa");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("BAGRo0UDAY");
            question.setVersionId(1);
            question.setLevelid(2);
            question.setQuestion("5jnZbUmCcC1o62dmwGA899gq2wRfD6AbSmqmsSaPnIMfYrT5oX");
            question.setQuestionIcon("Muf28rcJzhLMjz18tnZ1HpXcqBj0QCsehnvFxmXG6JeGFG4pgi");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "dut3hTESZGRKJ5TMYcJpXPkASYsDY8wFSEZyUplGDUYeGjuTiDNLbUcuSPTXER6kJ"));
