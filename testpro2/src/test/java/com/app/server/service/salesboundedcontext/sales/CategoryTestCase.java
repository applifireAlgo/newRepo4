...
public class CategoryTestCase extends EntityTestCriteria {
    ...
    private Category createCategory(Boolean isSave) throws Exception {
        ...
        category.setCategory("9HBDxV85EFvGMjP82qJbKSa1GC4TAxcbPssPKTpRn6desHc7tO");
    ...
    public void test2Update() {
        try {
            ...
            category.setCategory("gZ6GdlW0brKtBa1oiXf0svVtaU7YYEhoUpeKlX1PNiPWJWxWUp");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "category", "sS3TqOr4hYGYbd15Ws4VsYzxhqNWoEshQrGEmO2JxfBn4Cv0q4BzTCg8dnDoSTFlm"));
