...
public class CurrentMonthTestCase extends EntityTestCriteria {
    ...
    private CurrentMonth createCurrentMonth(Boolean isSave) throws Exception {
        ...
        currentmonth.setMonthname("4ajkxLI4U0oeSF6MJE3xCqPcx3qW4fIqrknHjRS3504iYV2w4t");
    ...
    public void test2Update() {
        try {
            ...
            currentmonth.setMonthname("yPxUlSPc0x8zvdNKN1ZGiNXJXPxEqBydSMf865AstQxxE2v23u");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "monthname", "hE6prn18jlQva9k3gpYA9Oq8ttoOMgGhbooTmuhGqxmlUzVFXptJiGitUKBbNOMcl"));
