...
public class RetailerTestCase extends EntityTestCriteria {
    ...
    private Retailer createRetailer(Boolean isSave) throws Exception {
        ...
        salesregion.setRegionname("BQPKiZ6sQMAKJimJqUq8fpdojoVlluOeTYvJghHWEAd7n6N4aV");
        ...
        distributor.setDistributorname("2FnmfnoDrHb05Y6U7lZWtvq2sv7I6QfUxdjcqSYglYhkTR85jF");
        distributor.setLattitude(-2000.0d);
        distributor.setLongitude(9900.0d);
        ...
        retailer.setRetailername("XimmKKwW5jkXXyHvAp7YUlTOGiUHKVVgYA0BdS30AX8b4CwCIB");
    ...
    public void test2Update() {
        try {
            ...
            retailer.setRetailername("kWaVWWeZlB8hxqI4BIjbL0cpOvhbvRKyEKRRJqttJPA0iHzx9W");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "retailername", ""));
