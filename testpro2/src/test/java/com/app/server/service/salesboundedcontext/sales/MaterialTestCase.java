...
public class MaterialTestCase extends EntityTestCriteria {
    ...
    private Material createMaterial(Boolean isSave) throws Exception {
        ...
        brand.setBranddesc("szFNLSA7j3yZ6lTazALpmpVASL3MEog2ac3W6lnr8uUcEZ7fa1");
        Category category = new Category();
        category.setCategory("WMPipQjcyaP0HdkbNeKbyI6eAX0t9KVKN6VtUB5NU4T9xXbLsV");
        Category CategoryTest = new Category();
        if (isSave) {
            CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
        }
        brand.setBranddesc("Jx4NztvV3DQVdM1qDCYZxjROoLIXyY7oO89EviyRPjyL4Y6b3q");
        ...
        material.setMaterialdesc("HN9y3qmXSKt4frFWiRqId8KwUnr2OiurcAWPfxVn3U4VVlgWHp");
    ...
    public void test2Update() {
        try {
            ...
            material.setMaterialdesc("zfOPwQZb9tjUdo67qWPQaqnukxfZYRknkJpXF7jl6PJKHpgTvJ");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "materialdesc", "BVw1NTxdQmgBAImXjkFu8LQhx0RWHcX9khDUHPSyRPNOv86NDGY7Nd31YAyBZcDpD"));
