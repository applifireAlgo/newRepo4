...
public class DistributorTestCase extends EntityTestCriteria {
    ...
    private Distributor createDistributor(Boolean isSave) throws Exception {
        ...
        salesregion.setRegionname("p05UhSpiTb7TEkgNXtPJxIfL4k7Lg09xvIPKo5ZA6Xum8Vovn2");
        ...
        distributor.setDistributorname("IZMl4sc60rUgbSSCjOlsiTJlUMXzdG409m20NG6C93HO30MakJ");
        distributor.setLattitude(4100.0d);
        distributor.setLongitude(8000.0d);
    ...
    public void test2Update() {
        try {
            ...
            distributor.setDistributorname("4zQFVrOunYLnPb5E7XMFyRziDeIVCcz8v7Hgn4TPUN8lLcq3du");
            distributor.setLattitude(6900.0d);
            distributor.setLongitude(5600.0d);
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "distributorname", "PF9icn0oXYT2qzY5fe4MMwQgGeKCRm3RocGI2p6YOjZLSqWteBBdPpwD8QDnDrxhe"));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 3, "longitude", null));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "longitude", 1.5238601793322662E19d));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 5, "lattitude", null));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "lattitude", 1.4257285815981785E19d));
