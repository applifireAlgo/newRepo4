...
public class SalesRegionTestCase extends EntityTestCriteria {
    ...
    private SalesRegion createSalesRegion(Boolean isSave) throws Exception {
        ...
        salesregion.setRegionname("70pIYLk6iO17cArunLD2EUSnet2ViizDo7kbUt9oKwVIRbFEhz");
    ...
    public void test2Update() {
        try {
            ...
            salesregion.setRegionname("zHiBViT6V41sWgDydPsY5b3IPNjIiHAPSTeOqAKcqL25rCH5He");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "regionname", "9RP85EOo9zJuMeRIaa3VyzZeU8iTAs1Go2FVaIHvZVnssBlUvydcEXV6QIjR0uL88"));
