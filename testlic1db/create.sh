...
ART_CREATE_PATH=/tmp/applifire/db/NIKO9B9S38HWASN7SYLG/74155743-19A0-469B-9B26-4C33083DA3B1/art/create
AST_CREATE_PATH=/tmp/applifire/db/NIKO9B9S38HWASN7SYLG/74155743-19A0-469B-9B26-4C33083DA3B1/ast/create
MYSQL=/usr/bin
APPLFIREUSER=root
...
$MYSQL/mysql -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "SOURCE $ART_CREATE_PATH/art_log_alarm_events_t.sql";
...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "SOURCE $AST_CREATE_PATH/ast_TestA_T.sql"; 
